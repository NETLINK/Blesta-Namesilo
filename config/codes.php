...
Configure::set('Namesilo.status.codes', [
    ...
    '250' => [ 'Domain is already set to AutoRenew - No update made.', 'info' ],
    '251' => [ 'Domain is already set not to AutoRenew - No update made.', 'info' ],
    '252' => [ 'Domain is already Locked - No update made.', 'info' ],
    '253' => [ 'Domain is already Unlocked - No update made.', 'info' ],
    '254' => [ 'Nameserver update cannot be made. (details provided in response)', 'fail' ],
    '255' => [ 'Domain is already Private - No update made.', 'info' ],
    '256' => [ 'Domain is already Not Private - No update made.', 'info' ],
